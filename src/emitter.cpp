...
// global setters
bool Emitter::SetOutputCharset(EMITTER_MANIP::value value) {
  return m_pState->SetOutputCharset(value, FmtScope::Global);
}

bool Emitter::SetStringFormat(EMITTER_MANIP::value value) {
  return m_pState->SetStringFormat(value, FmtScope::Global);
}

bool Emitter::SetBoolFormat(EMITTER_MANIP::value value) {
  bool ok = false;
...
bool Emitter::SetNullFormat(EMITTER_MANIP::value value) {
  return m_pState->SetNullFormat(value, FmtScope::Global);
}

bool Emitter::SetIntBase(EMITTER_MANIP::value value) {
  return m_pState->SetIntFormat(value, FmtScope::Global);
}

bool Emitter::SetSeqFormat(EMITTER_MANIP::value value) {
  return m_pState->SetFlowType(GroupType::Seq, value, FmtScope::Global);
}

bool Emitter::SetMapFormat(EMITTER_MANIP::value value) {
  bool ok = false;
...
Emitter& Emitter::SetLocalValue(EMITTER_MANIP::value value) {
  if (!good())
    return *this;
...
StringEscaping::value GetStringEscapingStyle(const EMITTER_MANIP::value emitterManip) {
  switch (emitterManip) {
...
const char* Emitter::ComputeFullBoolName(bool b) const {
  const EMITTER_MANIP::value mainFmt = (m_pState->GetBoolLengthFormat() == EMITTER_MANIP::ShortBool
                                     ? EMITTER_MANIP::YesNoBool
                                     : m_pState->GetBoolFormat());
  const EMITTER_MANIP::value caseFmt = m_pState->GetBoolCaseFormat();
  switch (mainFmt) {
